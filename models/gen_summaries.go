...
type Summaries struct {
	...
	Result    Summaries_sub43 `json:"result"`
}
...
type Summaries_sub43 struct {
	...
	Bitfinex_bchusd                   Summaries_sub4  `json:"bitfinex:bchusd"`
	Bitfinex_bcubtc                   Summaries_sub7  `json:"bitfinex:bcubtc"`
	Bitfinex_bcuusd                   Summaries_sub11 `json:"bitfinex:bcuusd"`
	Bitfinex_bt1btc                   Summaries_sub14 `json:"bitfinex:bt1btc"`
	Bitfinex_bt1usd                   Summaries_sub9  `json:"bitfinex:bt1usd"`
	Bitfinex_bt2btc                   Summaries_sub7  `json:"bitfinex:bt2btc"`
	Bitfinex_bt2usd                   Summaries_sub16 `json:"bitfinex:bt2usd"`
	Bitfinex_btceur                   Summaries_sub18 `json:"bitfinex:btceur"`
	Bitfinex_btcusd                   Summaries_sub11 `json:"bitfinex:btcusd"`
	Bitfinex_btgbtc                   Summaries_sub4  `json:"bitfinex:btgbtc"`
	Bitfinex_btgusd                   Summaries_sub16 `json:"bitfinex:btgusd"`
	Bitfinex_dashbtc                  Summaries_sub7  `json:"bitfinex:dashbtc"`
	Bitfinex_dashusd                  Summaries_sub7  `json:"bitfinex:dashusd"`
	Bitfinex_databtc                  Summaries_sub20 `json:"bitfinex:databtc"`
	Bitfinex_dataeth                  Summaries_sub20 `json:"bitfinex:dataeth"`
	Bitfinex_datausd                  Summaries_sub20 `json:"bitfinex:datausd"`
	Bitfinex_datbtc                   Summaries_sub9  `json:"bitfinex:datbtc"`
	Bitfinex_dateth                   Summaries_sub4  `json:"bitfinex:dateth"`
	Bitfinex_datusd                   Summaries_sub21 `json:"bitfinex:datusd"`
	Bitfinex_edobtc                   Summaries_sub4  `json:"bitfinex:edobtc"`
	Bitfinex_edoeth                   Summaries_sub4  `json:"bitfinex:edoeth"`
	...
	Bitfinex_eosusd                   Summaries_sub21 `json:"bitfinex:eosusd"`
	Bitfinex_etcbtc                   Summaries_sub7  `json:"bitfinex:etcbtc"`
	Bitfinex_etcusd                   Summaries_sub7  `json:"bitfinex:etcusd"`
	Bitfinex_ethbtc                   Summaries_sub7  `json:"bitfinex:ethbtc"`
	Bitfinex_ethusd                   Summaries_sub16 `json:"bitfinex:ethusd"`
	Bitfinex_etpbtc                   Summaries_sub4  `json:"bitfinex:etpbtc"`
	Bitfinex_etpeth                   Summaries_sub4  `json:"bitfinex:etpeth"`
	Bitfinex_etpusd                   Summaries_sub7  `json:"bitfinex:etpusd"`
	Bitfinex_iotbtc                   Summaries_sub22 `json:"bitfinex:iotbtc"`
	Bitfinex_ioteth                   Summaries_sub21 `json:"bitfinex:ioteth"`
	Bitfinex_iotusd                   Summaries_sub21 `json:"bitfinex:iotusd"`
	...
	Bitfinex_saneth                   Summaries_sub21 `json:"bitfinex:saneth"`
	Bitfinex_sanusd                   Summaries_sub21 `json:"bitfinex:sanusd"`
	Bitfinex_xmrbtc                   Summaries_sub7  `json:"bitfinex:xmrbtc"`
	Bitfinex_xmrusd                   Summaries_sub26 `json:"bitfinex:xmrusd"`
	Bitfinex_xrpbtc                   Summaries_sub27 `json:"bitfinex:xrpbtc"`
	Bitfinex_xrpusd                   Summaries_sub21 `json:"bitfinex:xrpusd"`
	Bitfinex_zecbtc                   Summaries_sub7  `json:"bitfinex:zecbtc"`
	Bitfinex_zecusd                   Summaries_sub7  `json:"bitfinex:zecusd"`
	...
	Bithumb_etckrw                    Summaries_sub27 `json:"bithumb:etckrw"`
	Bithumb_ethkrw                    Summaries_sub9  `json:"bithumb:ethkrw"`
	Bithumb_ltckrw                    Summaries_sub9  `json:"bithumb:ltckrw"`
	Bithumb_qtumbtc                   Summaries_sub9  `json:"bithumb:qtumbtc"`
	Bithumb_qtumeth                   Summaries_sub27 `json:"bithumb:qtumeth"`
	Bithumb_qtumkrw                   Summaries_sub27 `json:"bithumb:qtumkrw"`
	Bithumb_xmrkrw                    Summaries_sub9  `json:"bithumb:xmrkrw"`
	Bithumb_xrpkrw                    Summaries_sub27 `json:"bithumb:xrpkrw"`
	Bithumb_zeckrw                    Summaries_sub9  `json:"bithumb:zeckrw"`
	Bitmex_bchbtc_monthly_futures     Summaries_sub21 `json:"bitmex:bchbtc-monthly-futures"`
	Bitmex_bchbtc_quarterly_futures   Summaries_sub20 `json:"bitmex:bchbtc-quarterly-futures"`
	Bitmex_btcjpy_monthly_futures     Summaries_sub29 `json:"bitmex:btcjpy-monthly-futures"`
	Bitmex_btcjpy_quarterly_futures   Summaries_sub30 `json:"bitmex:btcjpy-quarterly-futures"`
	Bitmex_btcusd_monthly_futures     Summaries_sub29 `json:"bitmex:btcusd-monthly-futures"`
	Bitmex_btcusd_perpetual_futures   Summaries_sub22 `json:"bitmex:btcusd-perpetual-futures"`
	Bitmex_btcusd_quarterly_futures   Summaries_sub30 `json:"bitmex:btcusd-quarterly-futures"`
	Bitmex_dashbtc_monthly_futures    Summaries_sub21 `json:"bitmex:dashbtc-monthly-futures"`
	Bitmex_dashbtc_quarterly_futures  Summaries_sub21 `json:"bitmex:dashbtc-quarterly-futures"`
	Bitmex_etcbtc_weekly_futures      Summaries_sub21 `json:"bitmex:etcbtc-weekly-futures"`
	Bitmex_ethbtc_monthly_futures     Summaries_sub21 `json:"bitmex:ethbtc-monthly-futures"`
	Bitmex_ethbtc_quarterly_futures   Summaries_sub21 `json:"bitmex:ethbtc-quarterly-futures"`
	Bitmex_ltcbtc_monthly_futures     Summaries_sub21 `json:"bitmex:ltcbtc-monthly-futures"`
	Bitmex_ltcbtc_quarterly_futures   Summaries_sub21 `json:"bitmex:ltcbtc-quarterly-futures"`
	Bitmex_xmrbtc_monthly_futures     Summaries_sub21 `json:"bitmex:xmrbtc-monthly-futures"`
	Bitmex_xmrbtc_quarterly_futures   Summaries_sub21 `json:"bitmex:xmrbtc-quarterly-futures"`
	Bitmex_xrpbtc_monthly_futures     Summaries_sub27 `json:"bitmex:xrpbtc-monthly-futures"`
	Bitmex_xrpbtc_quarterly_futures   Summaries_sub27 `json:"bitmex:xrpbtc-quarterly-futures"`
	Bitmex_xtzbtc_biquarterly_futures Summaries_sub22 `json:"bitmex:xtzbtc-biquarterly-futures"`
	Bitmex_xtzbtc_monthly_futures     Summaries_sub22 `json:"bitmex:xtzbtc-monthly-futures"`
	Bitmex_xtzbtc_quarterly_futures   Summaries_sub20 `json:"bitmex:xtzbtc-quarterly-futures"`
	Bitmex_zecbtc_monthly_futures     Summaries_sub21 `json:"bitmex:zecbtc-monthly-futures"`
	Bitmex_zecbtc_quarterly_futures   Summaries_sub21 `json:"bitmex:zecbtc-quarterly-futures"`
	Bitsquare_btcaud                  Summaries_sub20 `json:"bitsquare:btcaud"`
	Bitsquare_btceur                  Summaries_sub7  `json:"bitsquare:btceur"`
	Bitsquare_btcusd                  Summaries_sub16 `json:"bitsquare:btcusd"`
	Bitsquare_etcbtc                  Summaries_sub20 `json:"bitsquare:etcbtc"`
	Bitsquare_ethbtc                  Summaries_sub20 `json:"bitsquare:ethbtc"`
	Bitsquare_ltcbtc                  Summaries_sub20 `json:"bitsquare:ltcbtc"`
	Bitstamp_bchbtc                   Summaries_sub7  `json:"bitstamp:bchbtc"`
	Bitstamp_bcheur                   Summaries_sub32 `json:"bitstamp:bcheur"`
	Bitstamp_bchusd                   Summaries_sub24 `json:"bitstamp:bchusd"`
	Bitstamp_btceur                   Summaries_sub26 `json:"bitstamp:btceur"`
	Bitstamp_btcusd                   Summaries_sub9  `json:"bitstamp:btcusd"`
	Bitstamp_ethbtc                   Summaries_sub7  `json:"bitstamp:ethbtc"`
	Bitstamp_etheur                   Summaries_sub34 `json:"bitstamp:etheur"`
	Bitstamp_ethusd                   Summaries_sub24 `json:"bitstamp:ethusd"`
	Bitstamp_eurusd                   Summaries_sub21 `json:"bitstamp:eurusd"`
	Bitstamp_ltcbtc                   Summaries_sub7  `json:"bitstamp:ltcbtc"`
	Bitstamp_ltceur                   Summaries_sub16 `json:"bitstamp:ltceur"`
	Bitstamp_ltcusd                   Summaries_sub7  `json:"bitstamp:ltcusd"`
	Bitstamp_xrpbtc                   Summaries_sub27 `json:"bitstamp:xrpbtc"`
	Bitstamp_xrpeur                   Summaries_sub21 `json:"bitstamp:xrpeur"`
	Bitstamp_xrpusd                   Summaries_sub21 `json:"bitstamp:xrpusd"`
	Bittrex_batbtc                    Summaries_sub27 `json:"bittrex:batbtc"`
	Bittrex_bccbtc                    Summaries_sub7  `json:"bittrex:bccbtc"`
	Bittrex_bccusdt                   Summaries_sub26 `json:"bittrex:bccusdt"`
	Bittrex_blkbtc                    Summaries_sub9  `json:"bittrex:blkbtc"`
	Bittrex_btcusdt                   Summaries_sub9  `json:"bittrex:btcusdt"`
	Bittrex_dcrbtc                    Summaries_sub7  `json:"bittrex:dcrbtc"`
	Bittrex_edgbtc                    Summaries_sub9  `json:"bittrex:edgbtc"`
	Bittrex_etcbtc                    Summaries_sub21 `json:"bittrex:etcbtc"`
	...
	Bittrex_ethusdt                   Summaries_sub7  `json:"bittrex:ethusdt"`
	...
	Bittrex_vrcbtc                    Summaries_sub27 `json:"bittrex:vrcbtc"`
	Bittrex_vrmbtc                    Summaries_sub4  `json:"bittrex:vrmbtc"`
	Bittrex_vtcbtc                    Summaries_sub22 `json:"bittrex:vtcbtc"`
	Bittrex_xrpusdt                   Summaries_sub21 `json:"bittrex:xrpusdt"`
	Bittrex_zecusdt                   Summaries_sub16 `json:"bittrex:zecusdt"`
	Bittrex_zenbtc                    Summaries_sub4  `json:"bittrex:zenbtc"`
	Btce_bchbtc                       Summaries_sub7  `json:"btce:bchbtc"`
	Btce_bchusd                       Summaries_sub36 `json:"btce:bchusd"`
	Btce_btceur                       Summaries_sub7  `json:"btce:btceur"`
	Btce_btcrur                       Summaries_sub32 `json:"btce:btcrur"`
	Btce_btcusd                       Summaries_sub24 `json:"btce:btcusd"`
	...
	Btce_ethusd                       Summaries_sub26 `json:"btce:ethusd"`
	...
	Btce_zecusd                       Summaries_sub16 `json:"btce:zecusd"`
	Cexio_bchusd                      Summaries_sub34 `json:"cexio:bchusd"`
	Cexio_btceur                      Summaries_sub16 `json:"cexio:btceur"`
	Cexio_btcusd                      Summaries_sub24 `json:"cexio:btcusd"`
	Cexio_ethbtc                      Summaries_sub7  `json:"cexio:ethbtc"`
	Cexio_ethusd                      Summaries_sub7  `json:"cexio:ethusd"`
	Cexio_ltcbtc                      Summaries_sub20 `json:"cexio:ltcbtc"`
	Cexio_ltcusd                      Summaries_sub20 `json:"cexio:ltcusd"`
	Gdax_btceur                       Summaries_sub24 `json:"gdax:btceur"`
	Gdax_btcgbp                       Summaries_sub24 `json:"gdax:btcgbp"`
	Gdax_btcusd                       Summaries_sub24 `json:"gdax:btcusd"`
	Gdax_ethbtc                       Summaries_sub7  `json:"gdax:ethbtc"`
	Gdax_etheur                       Summaries_sub24 `json:"gdax:etheur"`
	...
	Gdax_ltcusd                       Summaries_sub7  `json:"gdax:ltcusd"`
	Gemini_btcusd                     Summaries_sub26 `json:"gemini:btcusd"`
	...
	Kraken_bcheur                     Summaries_sub38 `json:"kraken:bcheur"`
	Kraken_bchusd                     Summaries_sub11 `json:"kraken:bchusd"`
	Kraken_btccad                     Summaries_sub7  `json:"kraken:btccad"`
	Kraken_btceur                     Summaries_sub7  `json:"kraken:btceur"`
	Kraken_btcgbp                     Summaries_sub40 `json:"kraken:btcgbp"`
	Kraken_btcjpy                     Summaries_sub9  `json:"kraken:btcjpy"`
	Kraken_btcusd                     Summaries_sub26 `json:"kraken:btcusd"`
	Kraken_dashbtc                    Summaries_sub7  `json:"kraken:dashbtc"`
	Kraken_dasheur                    Summaries_sub16 `json:"kraken:dasheur"`
	Kraken_dashusd                    Summaries_sub24 `json:"kraken:dashusd"`
	Kraken_dogebtc                    Summaries_sub27 `json:"kraken:dogebtc"`
	Kraken_eosbtc                     Summaries_sub22 `json:"kraken:eosbtc"`
	...
	Kraken_etceur                     Summaries_sub16 `json:"kraken:etceur"`
	Kraken_etcusd                     Summaries_sub7  `json:"kraken:etcusd"`
	Kraken_ethbtc                     Summaries_sub7  `json:"kraken:ethbtc"`
	Kraken_ethcad                     Summaries_sub16 `json:"kraken:ethcad"`
	Kraken_etheur                     Summaries_sub7  `json:"kraken:etheur"`
	Kraken_ethgbp                     Summaries_sub34 `json:"kraken:ethgbp"`
	Kraken_ethjpy                     Summaries_sub9  `json:"kraken:ethjpy"`
	Kraken_ethusd                     Summaries_sub26 `json:"kraken:ethusd"`
	Kraken_gnobtc                     Summaries_sub7  `json:"kraken:gnobtc"`
	Kraken_gnoeth                     Summaries_sub7  `json:"kraken:gnoeth"`
	Kraken_gnoeur                     Summaries_sub20 `json:"kraken:gnoeur"`
	Kraken_gnousd                     Summaries_sub20 `json:"kraken:gnousd"`
	Kraken_icnbtc                     Summaries_sub27 `json:"kraken:icnbtc"`
	Kraken_icneth                     Summaries_sub21 `json:"kraken:icneth"`
	Kraken_ltcbtc                     Summaries_sub7  `json:"kraken:ltcbtc"`
	Kraken_ltccad                     Summaries_sub20 `json:"kraken:ltccad"`
	Kraken_ltceur                     Summaries_sub24 `json:"kraken:ltceur"`
	Kraken_ltcusd                     Summaries_sub32 `json:"kraken:ltcusd"`
	...
	Kraken_repcad                     Summaries_sub20 `json:"kraken:repcad"`
	Kraken_repeth                     Summaries_sub7  `json:"kraken:repeth"`
	Kraken_repeur                     Summaries_sub7  `json:"kraken:repeur"`
	Kraken_repjpy                     Summaries_sub20 `json:"kraken:repjpy"`
	Kraken_repusd                     Summaries_sub20 `json:"kraken:repusd"`
	Kraken_strbtc                     Summaries_sub27 `json:"kraken:strbtc"`
	Kraken_streur                     Summaries_sub20 `json:"kraken:streur"`
	Kraken_strusd                     Summaries_sub20 `json:"kraken:strusd"`
	Kraken_usdtusd                    Summaries_sub16 `json:"kraken:usdtusd"`
	Kraken_xmrbtc                     Summaries_sub4  `json:"kraken:xmrbtc"`
	Kraken_xmreur                     Summaries_sub32 `json:"kraken:xmreur"`
	Kraken_xmrusd                     Summaries_sub24 `json:"kraken:xmrusd"`
	Kraken_xrpbtc                     Summaries_sub27 `json:"kraken:xrpbtc"`
	Kraken_xrpcad                     Summaries_sub20 `json:"kraken:xrpcad"`
	Kraken_xrpeur                     Summaries_sub21 `json:"kraken:xrpeur"`
	Kraken_xrpjpy                     Summaries_sub20 `json:"kraken:xrpjpy"`
	Kraken_xrpusd                     Summaries_sub7  `json:"kraken:xrpusd"`
	Kraken_zecbtc                     Summaries_sub7  `json:"kraken:zecbtc"`
	Kraken_zeccad                     Summaries_sub20 `json:"kraken:zeccad"`
	Kraken_zeceur                     Summaries_sub26 `json:"kraken:zeceur"`
	Kraken_zecgbp                     Summaries_sub20 `json:"kraken:zecgbp"`
	Kraken_zecjpy                     Summaries_sub20 `json:"kraken:zecjpy"`
	Kraken_zecusd                     Summaries_sub24 `json:"kraken:zecusd"`
	Luno_btczar                       Summaries_sub9  `json:"luno:btczar"`
	Okcoin_btccny                     Summaries_sub20 `json:"okcoin:btccny"`
	Okcoin_btcusd                     Summaries_sub16 `json:"okcoin:btcusd"`
	Okcoin_btcusd_biweekly_futures    Summaries_sub21 `json:"okcoin:btcusd-biweekly-futures"`
	Okcoin_btcusd_quarterly_futures   Summaries_sub41 `json:"okcoin:btcusd-quarterly-futures"`
	Okcoin_btcusd_weekly_futures      Summaries_sub21 `json:"okcoin:btcusd-weekly-futures"`
	Okcoin_ltccny                     Summaries_sub20 `json:"okcoin:ltccny"`
	Okcoin_ltcusd                     Summaries_sub4  `json:"okcoin:ltcusd"`
	Okcoin_ltcusd_biweekly_futures    Summaries_sub30 `json:"okcoin:ltcusd-biweekly-futures"`
	Okcoin_ltcusd_quarterly_futures   Summaries_sub30 `json:"okcoin:ltcusd-quarterly-futures"`
	Okcoin_ltcusd_weekly_futures      Summaries_sub42 `json:"okcoin:ltcusd-weekly-futures"`
	...
	Poloniex_bchusdt                  Summaries_sub26 `json:"poloniex:bchusdt"`
	Poloniex_bcnbtc                   Summaries_sub20 `json:"poloniex:bcnbtc"`
	...
	Poloniex_btcusdt                  Summaries_sub26 `json:"poloniex:btcusdt"`
	Poloniex_btmbtc                   Summaries_sub18 `json:"poloniex:btmbtc"`
	Poloniex_btsbtc                   Summaries_sub27 `json:"poloniex:btsbtc"`
	Poloniex_burstbtc                 Summaries_sub27 `json:"poloniex:burstbtc"`
	...
	Poloniex_daobtc                   Summaries_sub20 `json:"poloniex:daobtc"`
	Poloniex_daoeth                   Summaries_sub20 `json:"poloniex:daoeth"`
	Poloniex_dashbtc                  Summaries_sub7  `json:"poloniex:dashbtc"`
	Poloniex_dashusdt                 Summaries_sub16 `json:"poloniex:dashusdt"`
	Poloniex_dashxmr                  Summaries_sub7  `json:"poloniex:dashxmr"`
	Poloniex_dcrbtc                   Summaries_sub7  `json:"poloniex:dcrbtc"`
	Poloniex_dgbbtc                   Summaries_sub27 `json:"poloniex:dgbbtc"`
	Poloniex_dogebtc                  Summaries_sub27 `json:"poloniex:dogebtc"`
	Poloniex_emc2btc                  Summaries_sub38 `json:"poloniex:emc2btc"`
	...
	Poloniex_ethusdt                  Summaries_sub24 `json:"poloniex:ethusdt"`
	Poloniex_expbtc                   Summaries_sub4  `json:"poloniex:expbtc"`
	Poloniex_fctbtc                   Summaries_sub4  `json:"poloniex:fctbtc"`
	Poloniex_fldcbtc                  Summaries_sub27 `json:"poloniex:fldcbtc"`
	...
	Poloniex_ltcusdt                  Summaries_sub7  `json:"poloniex:ltcusdt"`
	Poloniex_ltcxmr                   Summaries_sub7  `json:"poloniex:ltcxmr"`
	Poloniex_maidbtc                  Summaries_sub27 `json:"poloniex:maidbtc"`
	Poloniex_maidxmr                  Summaries_sub4  `json:"poloniex:maidxmr"`
	Poloniex_nautbtc                  Summaries_sub20 `json:"poloniex:nautbtc"`
	Poloniex_navbtc                   Summaries_sub38 `json:"poloniex:navbtc"`
	Poloniex_neosbtc                  Summaries_sub4  `json:"poloniex:neosbtc"`
	Poloniex_nmcbtc                   Summaries_sub4  `json:"poloniex:nmcbtc"`
	Poloniex_notebtc                  Summaries_sub20 `json:"poloniex:notebtc"`
	Poloniex_nxcbtc                   Summaries_sub9  `json:"poloniex:nxcbtc"`
	Poloniex_nxtbtc                   Summaries_sub27 `json:"poloniex:nxtbtc"`
	Poloniex_nxtusdt                  Summaries_sub21 `json:"poloniex:nxtusdt"`
	...
	Poloniex_scbtc                    Summaries_sub20 `json:"poloniex:scbtc"`
	Poloniex_sdcbtc                   Summaries_sub20 `json:"poloniex:sdcbtc"`
	Poloniex_sjcxbtc                  Summaries_sub20 `json:"poloniex:sjcxbtc"`
	Poloniex_steembtc                 Summaries_sub18 `json:"poloniex:steembtc"`
	Poloniex_steemeth                 Summaries_sub4  `json:"poloniex:steemeth"`
	Poloniex_storjbtc                 Summaries_sub9  `json:"poloniex:storjbtc"`
	Poloniex_stratbtc                 Summaries_sub4  `json:"poloniex:stratbtc"`
	Poloniex_strbtc                   Summaries_sub27 `json:"poloniex:strbtc"`
	Poloniex_strusdt                  Summaries_sub21 `json:"poloniex:strusdt"`
	Poloniex_sysbtc                   Summaries_sub9  `json:"poloniex:sysbtc"`
	...
	Poloniex_xcpbtc                   Summaries_sub7  `json:"poloniex:xcpbtc"`
	Poloniex_xembtc                   Summaries_sub27 `json:"poloniex:xembtc"`
	Poloniex_xmrbtc                   Summaries_sub7  `json:"poloniex:xmrbtc"`
	Poloniex_xmrusdt                  Summaries_sub36 `json:"poloniex:xmrusdt"`
	Poloniex_xpmbtc                   Summaries_sub27 `json:"poloniex:xpmbtc"`
	Poloniex_xrpbtc                   Summaries_sub27 `json:"poloniex:xrpbtc"`
	Poloniex_xrpusdt                  Summaries_sub21 `json:"poloniex:xrpusdt"`
	...
	Poloniex_zrxbtc                   Summaries_sub27 `json:"poloniex:zrxbtc"`
	Poloniex_zrxeth                   Summaries_sub4  `json:"poloniex:zrxeth"`
	Qryptos_etcbtc                    Summaries_sub20 `json:"qryptos:etcbtc"`
	Qryptos_ethbtc                    Summaries_sub7  `json:"qryptos:ethbtc"`
	Qryptos_ltcbtc                    Summaries_sub7  `json:"qryptos:ltcbtc"`
	Qryptos_repbtc                    Summaries_sub20 `json:"qryptos:repbtc"`
	Qryptos_xmrbtc                    Summaries_sub20 `json:"qryptos:xmrbtc"`
	Qryptos_xrpbtc                    Summaries_sub9  `json:"qryptos:xrpbtc"`
	Qryptos_zecbtc                    Summaries_sub20 `json:"qryptos:zecbtc"`
	Quoine_bchjpy                     Summaries_sub7  `json:"quoine:bchjpy"`
	...
	Quoine_btccny                     Summaries_sub20 `json:"quoine:btccny"`
	Quoine_btceur                     Summaries_sub7  `json:"quoine:btceur"`
	Quoine_btchkd                     Summaries_sub16 `json:"quoine:btchkd"`
	Quoine_btcidr                     Summaries_sub9  `json:"quoine:btcidr"`
	Quoine_btcinr                     Summaries_sub20 `json:"quoine:btcinr"`
	Quoine_btcjpy                     Summaries_sub16 `json:"quoine:btcjpy"`
	Quoine_btcphp                     Summaries_sub7  `json:"quoine:btcphp"`
	Quoine_btcsgd                     Summaries_sub16 `json:"quoine:btcsgd"`
	Quoine_btcusd                     Summaries_sub7  `json:"quoine:btcusd"`
	Quoine_ethaud                     Summaries_sub20 `json:"quoine:ethaud"`
	Quoine_ethbtc                     Summaries_sub7  `json:"quoine:ethbtc"`
	Quoine_ethcny                     Summaries_sub20 `json:"quoine:ethcny"`
	Quoine_etheur                     Summaries_sub20 `json:"quoine:etheur"`
	Quoine_ethhkd                     Summaries_sub20 `json:"quoine:ethhkd"`
	Quoine_ethidr                     Summaries_sub36 `json:"quoine:ethidr"`
	Quoine_ethinr                     Summaries_sub20 `json:"quoine:ethinr"`
	Quoine_ethjpy                     Summaries_sub24 `json:"quoine:ethjpy"`
	Quoine_ethphp                     Summaries_sub20 `json:"quoine:ethphp"`
	Quoine_ethsgd                     Summaries_sub7  `json:"quoine:ethsgd"`
	Quoine_ethusd                     Summaries_sub7  `json:"quoine:ethusd"`
}

type Summaries_sub13 struct {
	Change Summaries_sub12 `json:"change"`
...
type Summaries_sub26 struct {
	Price  Summaries_sub25 `json:"price"`
	Volume float64         `json:"volume"`
}
...
type Summaries_sub29 struct {
	Price  Summaries_sub28 `json:"price"`
	Volume float64         `json:"volume"`
}
...
type Summaries_sub40 struct {
	Price  Summaries_sub39 `json:"price"`
	Volume float64         `json:"volume"`
}
