...
type Summaries struct {
	...
	Result    Summaries_sub45 `json:"result"`
}
...
type Summaries_sub45 struct {
	...
	Bitfinex_bt1btc                   Summaries_sub10 `json:"bitfinex:bt1btc"`
	...
	Bitfinex_btcusd                   Summaries_sub12 `json:"bitfinex:btcusd"`
	Bitfinex_btgbtc                   Summaries_sub7  `json:"bitfinex:btgbtc"`
	Bitfinex_btgusd                   Summaries_sub22 `json:"bitfinex:btgusd"`
	...
	Bitfinex_datbtc                   Summaries_sub25 `json:"bitfinex:datbtc"`
	Bitfinex_dateth                   Summaries_sub26 `json:"bitfinex:dateth"`
	Bitfinex_datusd                   Summaries_sub27 `json:"bitfinex:datusd"`
	...
	Bitfinex_eosusd                   Summaries_sub7  `json:"bitfinex:eosusd"`
	...
	Bitfinex_ethusd                   Summaries_sub29 `json:"bitfinex:ethusd"`
	...
	Bitfinex_iotbtc                   Summaries_sub26 `json:"bitfinex:iotbtc"`
	Bitfinex_ioteth                   Summaries_sub27 `json:"bitfinex:ioteth"`
	Bitfinex_iotusd                   Summaries_sub30 `json:"bitfinex:iotusd"`
	Bitfinex_ltcbtc                   Summaries_sub7  `json:"bitfinex:ltcbtc"`
	Bitfinex_ltcusd                   Summaries_sub7  `json:"bitfinex:ltcusd"`
	...
	Bitfinex_qtumusd                  Summaries_sub27 `json:"bitfinex:qtumusd"`
	Bitfinex_sanbtc                   Summaries_sub4  `json:"bitfinex:sanbtc"`
	Bitfinex_saneth                   Summaries_sub7  `json:"bitfinex:saneth"`
	Bitfinex_sanusd                   Summaries_sub27 `json:"bitfinex:sanusd"`
	...
	Bitfinex_xrpusd                   Summaries_sub27 `json:"bitfinex:xrpusd"`
	Bitfinex_zecbtc                   Summaries_sub7  `json:"bitfinex:zecbtc"`
	Bitfinex_zecusd                   Summaries_sub29 `json:"bitfinex:zecusd"`
	...
	Bithumb_etckrw                    Summaries_sub12 `json:"bithumb:etckrw"`
	Bithumb_ethkrw                    Summaries_sub12 `json:"bithumb:ethkrw"`
	Bithumb_ltckrw                    Summaries_sub12 `json:"bithumb:ltckrw"`
	Bithumb_qtumbtc                   Summaries_sub12 `json:"bithumb:qtumbtc"`
	Bithumb_qtumeth                   Summaries_sub12 `json:"bithumb:qtumeth"`
	...
	Bitmex_bchbtc_monthly_futures     Summaries_sub27 `json:"bitmex:bchbtc-monthly-futures"`
	Bitmex_bchbtc_quarterly_futures   Summaries_sub24 `json:"bitmex:bchbtc-quarterly-futures"`
	Bitmex_btcjpy_monthly_futures     Summaries_sub25 `json:"bitmex:btcjpy-monthly-futures"`
	Bitmex_btcjpy_quarterly_futures   Summaries_sub25 `json:"bitmex:btcjpy-quarterly-futures"`
	Bitmex_btcusd_monthly_futures     Summaries_sub25 `json:"bitmex:btcusd-monthly-futures"`
	Bitmex_btcusd_perpetual_futures   Summaries_sub31 `json:"bitmex:btcusd-perpetual-futures"`
	Bitmex_btcusd_quarterly_futures   Summaries_sub25 `json:"bitmex:btcusd-quarterly-futures"`
	Bitmex_dashbtc_monthly_futures    Summaries_sub27 `json:"bitmex:dashbtc-monthly-futures"`
	Bitmex_dashbtc_quarterly_futures  Summaries_sub27 `json:"bitmex:dashbtc-quarterly-futures"`
	Bitmex_etcbtc_weekly_futures      Summaries_sub26 `json:"bitmex:etcbtc-weekly-futures"`
	Bitmex_ethbtc_monthly_futures     Summaries_sub27 `json:"bitmex:ethbtc-monthly-futures"`
	Bitmex_ethbtc_quarterly_futures   Summaries_sub27 `json:"bitmex:ethbtc-quarterly-futures"`
	Bitmex_ltcbtc_monthly_futures     Summaries_sub27 `json:"bitmex:ltcbtc-monthly-futures"`
	Bitmex_ltcbtc_quarterly_futures   Summaries_sub27 `json:"bitmex:ltcbtc-quarterly-futures"`
	Bitmex_xmrbtc_monthly_futures     Summaries_sub27 `json:"bitmex:xmrbtc-monthly-futures"`
	Bitmex_xmrbtc_quarterly_futures   Summaries_sub27 `json:"bitmex:xmrbtc-quarterly-futures"`
	...
	Bitmex_xtzbtc_biquarterly_futures Summaries_sub26 `json:"bitmex:xtzbtc-biquarterly-futures"`
	Bitmex_xtzbtc_monthly_futures     Summaries_sub26 `json:"bitmex:xtzbtc-monthly-futures"`
	Bitmex_xtzbtc_quarterly_futures   Summaries_sub24 `json:"bitmex:xtzbtc-quarterly-futures"`
	Bitmex_zecbtc_monthly_futures     Summaries_sub27 `json:"bitmex:zecbtc-monthly-futures"`
	Bitmex_zecbtc_quarterly_futures   Summaries_sub27 `json:"bitmex:zecbtc-quarterly-futures"`
	Bitsquare_btcaud                  Summaries_sub24 `json:"bitsquare:btcaud"`
	Bitsquare_btceur                  Summaries_sub7  `json:"bitsquare:btceur"`
	Bitsquare_btcusd                  Summaries_sub18 `json:"bitsquare:btcusd"`
	...
	Bitstamp_bcheur                   Summaries_sub7  `json:"bitstamp:bcheur"`
	Bitstamp_bchusd                   Summaries_sub7  `json:"bitstamp:bchusd"`
	Bitstamp_btceur                   Summaries_sub29 `json:"bitstamp:btceur"`
	Bitstamp_btcusd                   Summaries_sub29 `json:"bitstamp:btcusd"`
	Bitstamp_ethbtc                   Summaries_sub7  `json:"bitstamp:ethbtc"`
	Bitstamp_etheur                   Summaries_sub7  `json:"bitstamp:etheur"`
	Bitstamp_ethusd                   Summaries_sub7  `json:"bitstamp:ethusd"`
	Bitstamp_eurusd                   Summaries_sub27 `json:"bitstamp:eurusd"`
	Bitstamp_ltcbtc                   Summaries_sub7  `json:"bitstamp:ltcbtc"`
	Bitstamp_ltceur                   Summaries_sub7  `json:"bitstamp:ltceur"`
	Bitstamp_ltcusd                   Summaries_sub33 `json:"bitstamp:ltcusd"`
	Bitstamp_xrpbtc                   Summaries_sub25 `json:"bitstamp:xrpbtc"`
	Bitstamp_xrpeur                   Summaries_sub27 `json:"bitstamp:xrpeur"`
	Bitstamp_xrpusd                   Summaries_sub27 `json:"bitstamp:xrpusd"`
	Bittrex_batbtc                    Summaries_sub25 `json:"bittrex:batbtc"`
	Bittrex_bccbtc                    Summaries_sub7  `json:"bittrex:bccbtc"`
	Bittrex_bccusdt                   Summaries_sub16 `json:"bittrex:bccusdt"`
	Bittrex_blkbtc                    Summaries_sub12 `json:"bittrex:blkbtc"`
	Bittrex_btcusdt                   Summaries_sub16 `json:"bittrex:btcusdt"`
	Bittrex_dcrbtc                    Summaries_sub7  `json:"bittrex:dcrbtc"`
	Bittrex_edgbtc                    Summaries_sub12 `json:"bittrex:edgbtc"`
	...
	Bittrex_ethusdt                   Summaries_sub29 `json:"bittrex:ethusdt"`
	...
	Bittrex_qtumbtc                   Summaries_sub26 `json:"bittrex:qtumbtc"`
	Bittrex_stratbtc                  Summaries_sub4  `json:"bittrex:stratbtc"`
	Bittrex_vrcbtc                    Summaries_sub25 `json:"bittrex:vrcbtc"`
	Bittrex_vrmbtc                    Summaries_sub4  `json:"bittrex:vrmbtc"`
	Bittrex_vtcbtc                    Summaries_sub4  `json:"bittrex:vtcbtc"`
	Bittrex_xrpusdt                   Summaries_sub27 `json:"bittrex:xrpusdt"`
	Bittrex_zecusdt                   Summaries_sub18 `json:"bittrex:zecusdt"`
	Bittrex_zenbtc                    Summaries_sub7  `json:"bittrex:zenbtc"`
	Btce_bchbtc                       Summaries_sub7  `json:"btce:bchbtc"`
	Btce_bchusd                       Summaries_sub33 `json:"btce:bchusd"`
	Btce_btceur                       Summaries_sub7  `json:"btce:btceur"`
	Btce_btcrur                       Summaries_sub12 `json:"btce:btcrur"`
	Btce_btcusd                       Summaries_sub35 `json:"btce:btcusd"`
	...
	Btce_ethrur                       Summaries_sub29 `json:"btce:ethrur"`
	Btce_ethusd                       Summaries_sub16 `json:"btce:ethusd"`
	...
	Cexio_bchusd                      Summaries_sub7  `json:"cexio:bchusd"`
	Cexio_btceur                      Summaries_sub7  `json:"cexio:btceur"`
	Cexio_btcusd                      Summaries_sub29 `json:"cexio:btcusd"`
	Cexio_ethbtc                      Summaries_sub7  `json:"cexio:ethbtc"`
	Cexio_ethusd                      Summaries_sub16 `json:"cexio:ethusd"`
	Cexio_ltcbtc                      Summaries_sub24 `json:"cexio:ltcbtc"`
	Cexio_ltcusd                      Summaries_sub24 `json:"cexio:ltcusd"`
	Gdax_btceur                       Summaries_sub35 `json:"gdax:btceur"`
	Gdax_btcgbp                       Summaries_sub29 `json:"gdax:btcgbp"`
	Gdax_btcusd                       Summaries_sub29 `json:"gdax:btcusd"`
	Gdax_ethbtc                       Summaries_sub7  `json:"gdax:ethbtc"`
	Gdax_etheur                       Summaries_sub7  `json:"gdax:etheur"`
	Gdax_ethusd                       Summaries_sub29 `json:"gdax:ethusd"`
	...
	Gemini_btcusd                     Summaries_sub16 `json:"gemini:btcusd"`
	...
	Kraken_bcheur                     Summaries_sub37 `json:"kraken:bcheur"`
	Kraken_bchusd                     Summaries_sub7  `json:"kraken:bchusd"`
	Kraken_btccad                     Summaries_sub22 `json:"kraken:btccad"`
	Kraken_btceur                     Summaries_sub18 `json:"kraken:btceur"`
	Kraken_btcgbp                     Summaries_sub12 `json:"kraken:btcgbp"`
	Kraken_btcjpy                     Summaries_sub12 `json:"kraken:btcjpy"`
	Kraken_btcusd                     Summaries_sub16 `json:"kraken:btcusd"`
	Kraken_dashbtc                    Summaries_sub7  `json:"kraken:dashbtc"`
	Kraken_dasheur                    Summaries_sub18 `json:"kraken:dasheur"`
	Kraken_dashusd                    Summaries_sub29 `json:"kraken:dashusd"`
	Kraken_dogebtc                    Summaries_sub24 `json:"kraken:dogebtc"`
	...
	Kraken_etceur                     Summaries_sub18 `json:"kraken:etceur"`
	Kraken_etcusd                     Summaries_sub7  `json:"kraken:etcusd"`
	Kraken_ethbtc                     Summaries_sub7  `json:"kraken:ethbtc"`
	Kraken_ethcad                     Summaries_sub29 `json:"kraken:ethcad"`
	Kraken_etheur                     Summaries_sub7  `json:"kraken:etheur"`
	Kraken_ethgbp                     Summaries_sub22 `json:"kraken:ethgbp"`
	Kraken_ethjpy                     Summaries_sub12 `json:"kraken:ethjpy"`
	Kraken_ethusd                     Summaries_sub18 `json:"kraken:ethusd"`
	...
	Kraken_ltceur                     Summaries_sub33 `json:"kraken:ltceur"`
	Kraken_ltcusd                     Summaries_sub16 `json:"kraken:ltcusd"`
	...
	Kraken_usdtusd                    Summaries_sub18 `json:"kraken:usdtusd"`
	Kraken_xmrbtc                     Summaries_sub7  `json:"kraken:xmrbtc"`
	Kraken_xmreur                     Summaries_sub29 `json:"kraken:xmreur"`
	Kraken_xmrusd                     Summaries_sub7  `json:"kraken:xmrusd"`
	Kraken_xrpbtc                     Summaries_sub25 `json:"kraken:xrpbtc"`
	Kraken_xrpcad                     Summaries_sub24 `json:"kraken:xrpcad"`
	Kraken_xrpeur                     Summaries_sub27 `json:"kraken:xrpeur"`
	Kraken_xrpjpy                     Summaries_sub24 `json:"kraken:xrpjpy"`
	Kraken_xrpusd                     Summaries_sub27 `json:"kraken:xrpusd"`
	Kraken_zecbtc                     Summaries_sub7  `json:"kraken:zecbtc"`
	Kraken_zeccad                     Summaries_sub24 `json:"kraken:zeccad"`
	Kraken_zeceur                     Summaries_sub29 `json:"kraken:zeceur"`
	...
	Okcoin_btcusd_biweekly_futures    Summaries_sub27 `json:"okcoin:btcusd-biweekly-futures"`
	Okcoin_btcusd_quarterly_futures   Summaries_sub38 `json:"okcoin:btcusd-quarterly-futures"`
	Okcoin_btcusd_weekly_futures      Summaries_sub39 `json:"okcoin:btcusd-weekly-futures"`
	Okcoin_ltccny                     Summaries_sub24 `json:"okcoin:ltccny"`
	Okcoin_ltcusd                     Summaries_sub41 `json:"okcoin:ltcusd"`
	Okcoin_ltcusd_biweekly_futures    Summaries_sub27 `json:"okcoin:ltcusd-biweekly-futures"`
	Okcoin_ltcusd_quarterly_futures   Summaries_sub42 `json:"okcoin:ltcusd-quarterly-futures"`
	Okcoin_ltcusd_weekly_futures      Summaries_sub27 `json:"okcoin:ltcusd-weekly-futures"`
	Poloniex_ampbtc                   Summaries_sub12 `json:"poloniex:ampbtc"`
	Poloniex_ardrbtc                  Summaries_sub25 `json:"poloniex:ardrbtc"`
	Poloniex_bchbtc                   Summaries_sub7  `json:"poloniex:bchbtc"`
	Poloniex_bcheth                   Summaries_sub7  `json:"poloniex:bcheth"`
	Poloniex_bchusdt                  Summaries_sub18 `json:"poloniex:bchusdt"`
	Poloniex_bcnbtc                   Summaries_sub24 `json:"poloniex:bcnbtc"`
	...
	Poloniex_blkxmr                   Summaries_sub7  `json:"poloniex:blkxmr"`
	Poloniex_btcdbtc                  Summaries_sub7  `json:"poloniex:btcdbtc"`
	Poloniex_btcdxmr                  Summaries_sub7  `json:"poloniex:btcdxmr"`
	Poloniex_btcusdt                  Summaries_sub29 `json:"poloniex:btcusdt"`
	Poloniex_btmbtc                   Summaries_sub20 `json:"poloniex:btmbtc"`
	Poloniex_btsbtc                   Summaries_sub24 `json:"poloniex:btsbtc"`
	...
	Poloniex_dashusdt                 Summaries_sub33 `json:"poloniex:dashusdt"`
	...
	Poloniex_dogebtc                  Summaries_sub24 `json:"poloniex:dogebtc"`
	Poloniex_emc2btc                  Summaries_sub20 `json:"poloniex:emc2btc"`
	...
	Poloniex_ethusdt                  Summaries_sub18 `json:"poloniex:ethusdt"`
	...
	Poloniex_grcbtc                   Summaries_sub12 `json:"poloniex:grcbtc"`
	...
	Poloniex_ltcusdt                  Summaries_sub29 `json:"poloniex:ltcusdt"`
	...
	Poloniex_navbtc                   Summaries_sub37 `json:"poloniex:navbtc"`
	...
	Poloniex_nxcbtc                   Summaries_sub12 `json:"poloniex:nxcbtc"`
	Poloniex_nxtbtc                   Summaries_sub25 `json:"poloniex:nxtbtc"`
	Poloniex_nxtusdt                  Summaries_sub27 `json:"poloniex:nxtusdt"`
	...
	Poloniex_repusdt                  Summaries_sub18 `json:"poloniex:repusdt"`
	Poloniex_ricbtc                   Summaries_sub12 `json:"poloniex:ricbtc"`
	...
	Poloniex_xmrusdt                  Summaries_sub18 `json:"poloniex:xmrusdt"`
	Poloniex_xpmbtc                   Summaries_sub12 `json:"poloniex:xpmbtc"`
	Poloniex_xrpbtc                   Summaries_sub25 `json:"poloniex:xrpbtc"`
	Poloniex_xrpusdt                  Summaries_sub27 `json:"poloniex:xrpusdt"`
	...
	Qryptos_etcbtc                    Summaries_sub24 `json:"qryptos:etcbtc"`
	...
	Quoine_btchkd                     Summaries_sub18 `json:"quoine:btchkd"`
	Quoine_btcidr                     Summaries_sub12 `json:"quoine:btcidr"`
	Quoine_btcinr                     Summaries_sub24 `json:"quoine:btcinr"`
	Quoine_btcjpy                     Summaries_sub33 `json:"quoine:btcjpy"`
	Quoine_btcphp                     Summaries_sub18 `json:"quoine:btcphp"`
	Quoine_btcsgd                     Summaries_sub7  `json:"quoine:btcsgd"`
	Quoine_btcusd                     Summaries_sub44 `json:"quoine:btcusd"`
	...
	Quoine_ethidr                     Summaries_sub33 `json:"quoine:ethidr"`
	...
	Quoine_ethsgd                     Summaries_sub29 `json:"quoine:ethsgd"`
...
type Summaries_sub35 struct {
	Price  Summaries_sub34 `json:"price"`
	Volume float64         `json:"volume"`
}
...
type Summaries_sub44 struct {
	Price  Summaries_sub43 `json:"price"`
	Volume float64         `json:"volume"`
}
